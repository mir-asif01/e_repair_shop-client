    ...
    return <>
        ...
        <div className="relative flex flex-col items-center mx-auto lg:flex-row-reverse lg:max-w-5xl lg:mt-12 xl:max-w-6xl">
            ...
            <div className="w-full h-64 lg:w-1/2 lg:h-auto">
                <img className="h-full w-full object-cover" src="https://images.pexels.com/photos/2517330/pexels-photo-2517330.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="Winding mountain road" />
            </div>
            ...
            <div
                ...
                <div className="flex flex-col p-12 md:px-16">
                    <h2 class="text-2xl font-medium uppercase text-green-800 lg:text-4xl">Repairing the world__</h2>
                    <p className="mt-4">
