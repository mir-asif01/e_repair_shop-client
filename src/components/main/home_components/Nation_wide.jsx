                ...
                <div className="flex flex-col items-center space-y-4 text-center text-black">
                    ...
                    <div className="space-y-2">
                        <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl">
                            Welcome to our website__
                        </h1>
                        <p className="mx-auto my-6 text-xl max-w-[700px]">
                            Explore the wide range of our services. We provide 24/7 support by our dedicatted support team.
                        </p>
                    </div>
