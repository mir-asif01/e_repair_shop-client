...
const Best_works = () => {
    ...
    return (
        <div className="m-2 md:m-10 flex flex-col justify-center items-center">
            <h1 className="text-4xl font-semibold mb-10">Some of our best Works__</h1>
