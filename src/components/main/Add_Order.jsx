        ...
        <div className="w-full my-10 max-w-md p-8 space-y-3 rounded-xl border bg-white   font-sans mx-auto">
            ...
            <form action="" className="space-y-6">
                <div className="space-y-2 text-sm">
                    ...
                    <input type="text" name="order_name" id="username" placeholder="Username" className="w-full px-4 py-3 rounded-md border border-indigo-300 focus:outline-none focus:ring  " />
                </div>
                <div className="space-y-2 text-sm">
                    <label htmlFor="description" className="block ">
                        Order Description
                    </label>
                    <input type="password" name="description" id="password" placeholder="Password" className="w-full px-4 py-3 rounded-md border border-indigo-300 focus:outline-none focus:ring  " />
                </div>
                <div className="space-y-2 text-sm">
                    <label htmlFor="description" className="block ">
                        Product Name
